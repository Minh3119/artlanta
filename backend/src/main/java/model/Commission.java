...
public class Commission {
    ...
    public Commission(int ID, int requestID, String title, String description, double price, LocalDateTime deadline, String fileDeliveryURL, String previewImageURL, String status, boolean artistSeenFinal, boolean clientConfirmed, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.ID = ID;
